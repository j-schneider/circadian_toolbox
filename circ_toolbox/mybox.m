...
%MYBOX put a text label in a figure in a corner
% mybox(text,pos)
% See: Help legend
% Mybox is identical to legend except for the fact that 
% it does not put symbols or relate to the graphical objects
% so it allows you to label the figure with an arbitrary text.

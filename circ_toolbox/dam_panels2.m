function dam_panels2(o,wells,dhours,plotrows,row,par)
%DAM_PANELS2   Row of panels with various analysis for dam data
% dam_panels2(o,i,mod_hours,plotrows,row,par)
%
...
% mod_hours - allows you to plot histograms modulo hours
%             Works for histograms and phase
%             Else keep it at 24
%
...
%     'fhist' - histogram of filtered data
...
%
% example:
% o=dam_load('E21');p=dam_panels_par; % p.plotcols={'histo' 'phase'};
% p.lopass=0;dam_panels2(o,1:8,24,1,1,p);
...
%%(C)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Added mod_hour option and lines 93/94 [j.schneider@utoronto.ca]
...
%     end
   ...
   case 'hist'
    ...
    thistitle='Histogram';
       ...
       case 'fhis'
    newhist(filterf,o.x(1),o.int,24,[],o.lights);
    thistitle='Filtered Histogram';
    
   case 'auto'
    %[ac,xx,ci]=joelaut(f,2);
    [ac,xx,ci]=autoco(filterf,60/o.int);
    acplot2(ac,xx,ci,par.peakRange,par.acPeak);
   ...
   case 'mesa'
    ...
    mesaplot(mesaf,o.int,par.peakRange,par.mesaFunct,par.mesaOrder);
    thistitle='MESA';
   ...
   case 'scop'
    ...
    thistitle='Peaks';
       ...
       case 'phas'
    o1=dam_select(o,wells);
    grouprayleigh(o1);
    thistitle='Rayleigh test';

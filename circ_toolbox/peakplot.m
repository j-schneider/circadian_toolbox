function [hour,height]=peakplot(ff,start,int,lights,hours,cutoff)
%FLYPLOT plot fly activity data
% [hour,height]=peakplot(ff,start,int,lights,hours,cutoff)
%
...
% hours: no. of hours on the Butterworth filter

function flyplot(ff,start,int,lights,showpeaks)
%FLYPLOT plot fly activity data
% flyplot(ff,start,int,lights,showpeaks)
%
...
% showpeaks: Select 1 here to plot *'s on each activity 
% peak (this only makes sense with smoothed out data, e.g. see 
% help butt_filter).
% 

...
function [num, den, z, p] = mybutter(n, Wn, varargin)
...
%   $Revision: 1.1 $  $Date: 2002/10/14 21:30:30 $

%   References:
%     [1] T. W. Parks and C. S. Burrus, Digital Filter Design,
%         John Wiley & Sons, 1987, chapter 7, section 7.3.3.

[btype,analog,errStr] = myiirchk(Wn,varargin{:});
error(errStr)
...
if btype == 1           % Lowpass
        [a,b,c,d] = mylp2lp(a,b,c,d,Wn);

elseif btype == 2       % Bandpass
        [a,b,c,d] = mylp2bp(a,b,c,d,Wn,Bw);

elseif btype == 3       % Highpass
        [a,b,c,d] = mylp2hp(a,b,c,d,Wn);

elseif btype == 4       % Bandstop
        [a,b,c,d] = mylp2bs(a,b,c,d,Wn,Bw);
end

% step 5: Use mybilinear transformation to find discrete equivalent:
if ~analog,
        [a,b,c,d] = mybilinear(a,b,c,d,fs);
end
